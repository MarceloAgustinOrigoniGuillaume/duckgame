...
Bullet::Bullet(int init_coord_x, int init_coord_y, int range_, TypeDynamicObject type_, int id_player_, int dmg_):
        physical_bullet(init_coord_x, init_coord_y), range(range_ * 16), type(type_),
        id_player(id_player_), dmg(dmg_), speed{0, 0}, bounce(false){}

Bullet::Bullet(int init_coord_x, int init_coord_y, int range_, TypeDynamicObject type_, int id_player_, int dmg_, bool bounce_):
        physical_bullet(init_coord_x, init_coord_y), range(range_ * 16), type(type_),
        id_player(id_player_), dmg(dmg_), speed{0, 0}, bounce(bounce_){}
